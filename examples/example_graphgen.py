...
def main():
    ...
    optparser.add_option(
        "-t", "--top", dest="topmodule", default="TOP", help="Top module, Default=TOP"
    )
    optparser.add_option(
        "--nobind",
        action="store_true",
    ...
    optparser.add_option(
        "--step", dest="step", type="int", default=1, help="# Search Steps, Default=1"
    )
    optparser.add_option(
        "--reorder",
        action="store_true",
    ...
    graphgen = VerilogGraphGenerator(
        options.topmodule,
        terms,
        binddict,
        resolved_terms,
