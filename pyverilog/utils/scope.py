...
class ScopeLabel(object):
    def __init__(self, scopename, scopetype="any", scopeloop=None):
        ...
        if scopetype not in scopetype_list:
            raise verror.DefinitionError("No such Scope type")
    ...
    def __eq__(self, other):
        ...
        return (self.scopename, self.scopetype, self.scopeloop) == (
            other.scopename,
            other.scopetype,
            other.scopeloop,
        )
    ...
    def __hash__(self):
        ...
        return hash(
            (self.scopename, self.scopeloop)
        )  # to use for dict key with any scopetype
